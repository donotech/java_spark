...
public class DiscountTest {
    ...
    public void testUniqueStores() {
        ...
        Assert.assertTrue(uniqueStoresDf.filter("storeid=1").count() == 1);
    ...
    public void testDiscount() {
        ...
        Dataset<Row> salesDf = spark.createDataset(salesList, Encoders.bean(Sales.class)).toDF();
        //Dataset<Sales> sales1Ds = spark.createDataset(salesList, Encoders.bean(Sales.class)) ;
        //Dataset<Row> rowSalesDf = sales1Ds.toDF();
